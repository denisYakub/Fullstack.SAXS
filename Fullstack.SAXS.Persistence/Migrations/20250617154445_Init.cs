    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sp_data", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "sp_generation_number_counter",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    generation_current_number = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_sp_generation_number_counter", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    generation_number = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    id_sp_data = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_sp_generation", x => x.id);
                    table.ForeignKey(
                        name: "FK_sp_generation_sp_data_id_sp_data",
                        column: x => x.id_sp_data,
